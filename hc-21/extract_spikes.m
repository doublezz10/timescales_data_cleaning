...
filenames = getfn('/Users/zachz/Downloads/CRCNS_scripts/hc-21/data');

d = dir('/Users/zachz/Downloads/CRCNS_scripts/hc-21/data');
d(1:2) = [];
...
for file_n = 1:length(filenames)
    ...
    if isfield(file,'elec') == 1
        ...
        if isfield(file,'newallo') == 1
            ...
            cell_info{1,file_n} = struct('dataset','Wirth2','species','monkey','individual',monkey_num,'brain_area','hippocampus','coords',file.reclocation);
...
save 'wirth2.mat' spikes cell_info
save 'wirth2_by_trial.mat' spikes_by_trial cell_info